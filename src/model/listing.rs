...
///
/// ```rust
/// use llm_provider::model::{Model, ModelList};
///
...
impl ModelList {
    ...
    ///
    /// ```rust
    /// use llm_provider::model::ModelList;
    ///
    /// let empty = ModelList::new(vec![]);
    /// assert!(empty.is_empty());
    ///
    /// let non_empty = ModelList::new(vec![llm_provider::model::Model::from_id("gpt-4")]);
